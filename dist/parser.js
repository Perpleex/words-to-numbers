...
var canAddTokenToEndOfSubRegion = function canAddTokenToEndOfSubRegion(subRegion, currentToken, _ref) {
  ...
  var prevprevToken = tokens[1];
  if (!prevToken) return true;
  if (prevToken.type === _constants.TOKEN_TYPE.MAGNITUDE && currentToken.type === _constants.TOKEN_TYPE.UNIT && (_constants.NUMBER[prevToken.lowerCaseValue] < 1000 || prevprevToken && _constants.NUMBER[prevprevToken.lowerCaseValue] > _constants.NUMBER[prevToken.lowerCaseValue])) {
    return true;
  }
  if (prevToken.type === _constants.TOKEN_TYPE.MAGNITUDE && currentToken.type === _constants.TOKEN_TYPE.TEN && (_constants.NUMBER[prevToken.lowerCaseValue] < 1000 || prevprevToken && _constants.NUMBER[prevprevToken.lowerCaseValue] > _constants.NUMBER[prevToken.lowerCaseValue])) {
    return true;
  }
